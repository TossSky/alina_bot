...
def create_image_message(image_bytes: bytes, text: str = "реагируй живо, как в переписке, скажи что думаешь или чувствуешь. Можешь предложение, а можешь пару-тройку", 
